...
function Footer() {
  return (
    <footer className="py-10 bg-color-grey mt-auto">
      <div className="max-w-[1280px] mx-auto  px-[115px] lg:px-[72px] sm:px-[30px]">
        <div className="flex xl:gap-5 xl:grid-cols-2 lg:grid-cols-1 justify-between lg:grid lg:gap-0 gap-10">
          <div className="flex grid-cols-2 lg:grid-cols-1 gap-5 lg:grid justify-between">
            <div className="w-2/3 xl:w-4/5 md:w-full">
          ...
          <div className="lg:w-full xl:w-3/5 sm:w-full">
            <span className="text-22px capitalize text-color-white font-bold lg:text-22px font-space-mono">
            ...
            <div className="grid mt-[25px] lg:mt-5 text-[#CCC] grid-rows-1 gap-5 font-work-sans">
              ...
              <form
                action="#"
                className="flex font-work-sans text-color-black lg:w-2/3 md:w-full sm:h-[46px] sm:gap-4 sm:grid sm:grid-cols-1 sm:w-full font-semibold outline-none rounded-[20px] items-center h-[60px] bg-color-white justify-between"
              >
                <input
                  type="text"
                  placeholder="Enter your email here"
                  className="outline-none h-[60px] sm:h-[46px] md:w-3/5 xl:w-full sm:w-full rounded-[20px] px-5 text-color-black"
                />
                <button className="bg-color-violet sm:h-[46px] sm:w-full text-color-white px-[50px] xl:px-[30px] lg:px-[50px] rounded-[20px] h-full">
                  {/* <SeeImgIcon /> */}
                  Subscribe
                </button>
              </form>
