...
function RankingsTab3() {
  return (
    <table className="table w-full">
      <thead>
        <tr className="flex items-center justify-between border-[1px] bg-blue-500 px-5 py-3 rounded-[20px] border-color-grey gap-5 w-full text-16px sm:text-12px  text-white font-space-mono text-center">
